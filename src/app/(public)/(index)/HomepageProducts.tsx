  ...
  return (
    <section className="app-container relative w-full px-4 py-12 md:py-16">
      <div className="flex justify-between items-end mb-8">
        <div>
          <h2 className="text-2xl md:text-3xl font-bold text-primary-darkRed mb-2">Luxury Collection</h2>
          <p className="text-gray-600 text-sm md:text-base">Discover our handpicked selection of premium products.</p>
        </div>
