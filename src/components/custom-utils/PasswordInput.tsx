...
import { LoginAccountFormData } from "@/schemas/login.schema";
  ...
  return (
    <div className="relative w-full">
      <input
        ...
        id={id}
        className={`bg-gray-100/80 border border-gray-100 rounded-md p-4 text-sm block w-full outline-none focus:ring-2
