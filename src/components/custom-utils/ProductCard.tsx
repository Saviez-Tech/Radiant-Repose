    ...
    <div  
        ...
        <div className="p-2 flex flex-col justify-between flex-grow">
            ...
            <div className="flex justify-between items-center my-2 gap-2">
                ...
                <p className="text-primary-dark_gray text-right text-xs capitalize truncate"><span className="font-semibold">Category:</span> {productType?.split("-").join(" ")}</p>
            </div>
            ...
            <div className="flex justify-between items-center overflow-hidden gap-2 pb-1">
                ...
                <div className="flex flex-col gap-2 items-center">
                 <button className="bg-primary-light_amber text-white rounded-3xl py-2 px-3 text-[8px] md:text-xs truncate">Add to Cart</button>
                </div>
            </div>
        </div>
        </div>
