...
export default function AddNewStaffBtn() {
    ...
    return (
        <button
        onClick={() => router.push("/admin/staff-management/new-staff")}
        className="w-fit h-12 group bg-gradient-to-r from-[#990000] to-[#FF0000] hover:from-[#b30000] hover:to-[#cc0000]
                    active:scale-95 text-white font-medium text-xs md:text-sm p-3 rounded-lg inline-flex items-center gap-2
