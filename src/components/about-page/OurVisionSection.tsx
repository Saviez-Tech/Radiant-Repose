        ...
        <section className="glob-px pt-14 pb-8 md:flex gap-16 justify-between">
            ...
            <div className="">
                <p className="text-sm text-primary-base_color2 mt-2 mb-6">
                    To become Nigeria&apos;s trusted destination for quality imported products, offering children&apos;s essentials, luxury gifts, home, kitchen, and lifestyle collections.
                </p>
