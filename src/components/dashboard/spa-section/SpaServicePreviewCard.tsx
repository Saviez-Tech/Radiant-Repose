...
export default function SpaServicePreviewCard({ service_duration, service_name, status, service_description }: ServiceListVerificationData){
    ...
    <div className="p-4 space-y-4">
        <div className="flex items-center justify-between border border-gray-100 p-2 rounded-2xl">
            ...
            <div className="flex flex-col items-center space-y-2">
                ...
                <Select value={status}>
                <SelectTrigger className={`max-w-[6em] w-fit text-xs text-center rounded-2xl focus:outline-none focus:ring-0 ${status === "Pending" ? "bg-primary-dark_gray/15 text-primary-dark_gray/60" : "bg-[#33CC33]/15 text-[#33CC33]"}`}>
