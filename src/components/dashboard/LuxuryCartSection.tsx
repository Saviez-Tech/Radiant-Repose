...
export default function LuxuryCartSection() {

  const { scannedItems, orderNumber } = useAppSelector(store => store.luxuryPosFlow)
  ...
  return (
    ...
    null
    :
    pathName.startsWith("/pos") && !pathName.includes("/service-verification") && !pathName.includes("/spa-section") && !pathName.includes("/transaction-history") && !pathName.includes("/loyalty")
    ?
